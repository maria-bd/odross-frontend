...
const Login3 = () => { // Changed the component name to Login2
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            try {
                const response = await fetch(API_URLS.login3, { // Updated the API_URLS to teacherLogin
                    method: 'POST',
                    headers: {
    ...
    return (
        <div className="login-container">
            <h2>Admin Login</h2> {/* Updated the title */}
...
export default Login3; // Exported the component as Login2
